      ...
      <div className="w-full max-w-sm">
        <section className="space-y-6 rounded-lg bg-card p-8 ring-1 ring-border">
          <div className="flex flex-col items-center space-y-3 text-center">
            ...
            <h1 className="text-xl font-semibold tracking-tight">Welcome to Outpost</h1>
            <p className="text-sm text-muted-foreground">Webhook events dashboard for GitHub App integrations</p>
          </div>
