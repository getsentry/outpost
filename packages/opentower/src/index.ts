// opentower: receives GitHub App webhooks and dispatches to OpenCode
// agents via the in-process SDK client. Uses Hono for routing, Sentry
// for observability (traces, structured logs, error tracking).
