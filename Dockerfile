...
# Bundled plugin packages. The `lantern` plugin lives under
...
# Default config for the lantern plugin: 3 broad triggers
...
# to 4096 locally. WEBHOOK_PORT (default 5050) is what the lantern
